...
__conda_setup="$('/home/yangziyin/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/yangziyin/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/yangziyin/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/yangziyin/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export NEMU_HOME=/home/yangziyin/cs_files/ics2022/nemu
